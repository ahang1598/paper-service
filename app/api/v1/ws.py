...
from app.api.deps import make_default_device
...
def _resolve_request_id(req_id: Optional[str]) -> str:
    if req_id:
        return req_id
...
async def ws_query(
    ...
    try:
        while True:
            ...
            request_id = _resolve_request_id(raw.get("request_id") or opts.get("request_id"))
