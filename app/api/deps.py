...
from app.clients.doc_fulltext_client import DeviceInfo, DocFullTextClient, ServiceConfig
...
from app.core.security import extract_bearer_header, verify_token
