...
from app.middleware.logging import configure_redacting_logger
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    import app.services.document.fulltext_handler  # noqa: F401
...
def _safe_list_actions() -> list[str]:
    ...
    try:
        from app.core.registry import list_actions
        return list_actions()
    except Exception:
        return []
